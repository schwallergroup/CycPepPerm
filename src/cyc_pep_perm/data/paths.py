...
TRAIN_RANDOM_DW = os.path.join(
    DATA_PATH, "perm_random80_train_dw.csv"
)
TRAIN_RANDOM_MORDRED = os.path.join(
    DATA_PATH, "perm_random80_train_mordred.csv"
)
TEST_RANDOM_DW = os.path.join(
    DATA_PATH, "perm_random20_test_dw.csv"
)
TEST_RANDOM_MORDRED = os.path.join(
    DATA_PATH, "perm_random20_test_mordred.csv"
)
